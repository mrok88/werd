...
function add_relation(parent_1, row_1, parent_2, row_2) {
	...
	*/
    console.log("add_relation(parent_1, row_1, parent_2, row_2)=>",parent_1, row_1, parent_2, row_2); // modi by wonseokyou
...
function load(keyword) {
	...
	if (keyword == "") {
        ...
        if ( keyword == 'ora') {
            // for oracle test by wonseokyou 2018-08-09
            ajax_command(GET,"io-ora.php?import=import&key="+encodeURIComponent(keyword),function(){return "";},import_xml);        
        } else {
